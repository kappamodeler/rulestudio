...
public class NewWorkbenchPerspective implements IPerspectiveFactory {

	public final static String ID = NewWorkbenchPerspective.class.getCanonicalName();
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		right.addView("com.plectix.rulestudio.views.rulevisualizer.RuleVisualizerView");
